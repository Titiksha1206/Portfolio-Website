  ...
  return (
    <div className="home__data">
      ...
      <p className="home__description">
        Elevating digital landscapes with seamless front-end elegance and robust
        back-end architecture.
        {/* Skilled in HTML, CSS, and JavaScript, dedicated to merging aesthetics with seamless functionality to deliver captivating and responsive websites that elevate user experiences to new heights and leave a lasting impression. */}
      </p>
